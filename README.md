...
* Data containers: `hyperflowwms/montage2-workflow-data:montage2-2mass-025-latest` (small, 619 jobs), `matplinta/montage2-workflow-data:degree1.0` (large, 4800 jobs), `hyperflowwms/montage2-workflow-data:montage2-dss-3.0-latest` (very large, 31768 jobs)
